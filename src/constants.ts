...
// Shared deployment on Monad (143), Cronos (25) and HyperEVM (999)
const NATIVE_ORDER_FACTORY_MONAD_CRONOS_HYPEREVM =
...
// Shared deployment on Monad (143), Cronos (25) and HyperEVM (999)
const NATIVE_ORDER_IMPL_MONAD_CRONOS_HYPEREVM =
...
export const getNativeOrderFactoryContract = (chainId: number): string => {
    ...
    if (
        ...
        return NATIVE_ORDER_FACTORY_MONAD_CRONOS_HYPEREVM
    }
...
export const getNativeOrderImplContract = (chainId: number): string => {
    ...
    if (
        ...
        return NATIVE_ORDER_IMPL_MONAD_CRONOS_HYPEREVM
    }
